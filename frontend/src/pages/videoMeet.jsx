...
const peerConfigConnections = {
    "iceServers": [
        { "url": "stun:stun.l.googal.com:19302"}
    ]
}
    ...
    return (
        <div>
            ...
            <div className='lobby-container'>
                ...
                <TextField style={{marginBottom: "2rem"}} id="outlined-basic" label="username" value={username} onChange={e => setUsername(e.target.value)}/>
